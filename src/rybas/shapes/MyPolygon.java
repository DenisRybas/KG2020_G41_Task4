...
public class MyPolygon {
    ...
    public void rotate(boolean CW, double xDegrees, double yDegrees,
                       double zDegrees, MyVector lightVector1,
                       MyVector lightVector2) {
        for (MyPoint p : points) {
        ...
        this.updateVisibility();
        this.setLighting(lightVector1, lightVector2);
    }
    ...
    public static List<MyPolygon> sortPolygons(List<MyPolygon> polygons) {
        polygons.sort((p1, p2) -> {
...
//		double dot = MyVector.dot(normal, lightVector1);
...
//		this.updateLightingColor(lightRatio);
        ...
        dot1 = (dot1 + 1) / 2 * (1 - AmbientLight);

        double dot2 = MyVector.dot(normal, lightVector1);
        double sign2 = dot2 < 0 ? -1 : 1;
